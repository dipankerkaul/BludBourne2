...
import com.packtub.libgdx.bludbourne.Entity2;
...
public abstract class PhysicsComponent extends ComponentSubject implements Component{
    ...
    protected void initBoundingBox(float percentageWidthReduced, float percentageHeightReduced){
        ...
        float origWidth =  Entity2.FRAME_WIDTH;
        float origHeight = Entity2.FRAME_HEIGHT;
        ...
        if( widthReductionAmount > 0 && widthReductionAmount < 1){
            width = Entity2.FRAME_WIDTH * widthReductionAmount;
        }else{
            width = Entity2.FRAME_WIDTH;
        }

        if( heightReductionAmount > 0 && heightReductionAmount < 1){
            height = Entity2.FRAME_HEIGHT * heightReductionAmount;
        }else{
            height = Entity2.FRAME_HEIGHT;
        }
    ...
    protected void updateBoundingBoxPosition(Vector2 position){
        ...
        switch(_boundingBoxLocation){
            case BOTTOM_LEFT:
                ...
                break;
            case BOTTOM_CENTER:
                _boundingBox.setCenter(minX + Entity2.FRAME_WIDTH/2, minY + Entity2.FRAME_HEIGHT/4);
                break;
            case CENTER:
                _boundingBox.setCenter(minX + Entity2.FRAME_WIDTH/2, minY + Entity2.FRAME_HEIGHT/2);
                break;
        }
